        ...
        <div class="mx-auto">
            ...
            <div class="bg-sidebar overflow-hidden shadow-sm mb-2 sm:rounded-lg flex flex-col md:flex-row justify-between items-center">
                <div class="p-4 text-white text-xl">
                    {{ __("Welcome Back,") }} <span>{{ auth()->user()->role === 'admin' ? 'Administrator' : ''}}</span>
                </div>
            ...
            {{-- analytics --}}
            <div class="overflow-hidden shadow-sm rounded flex flex-wrap flex-col gap-2 md:flex-row items-center p-2">
                ...
                <div class="w-full md:w-fit border border-green-700 rounded-md p-4 flex gap-2 justify-between items-center">
                    ...
                    <div class="border bg-sidebar rounded-md p-2">
                        <img class="w-16" src="{{ asset('img/college.png') }}" alt="" srcset="">
                    </div>
                </div>
                ...
                <div class="w-full md:w-fit border border-green-700 rounded-md p-4 flex gap-2 justify-between items-center">
                    ...
                    <div class="border bg-sidebar rounded-md p-2">
                        <img class="w-16" src="{{ asset('img/teacher.png') }}" alt="" srcset="">
                    </div>
                </div>
                ...
                <div class="w-full md:w-fit border border-green-700 rounded-md p-4 flex gap-2 justify-between items-center">
                    ...
                    <div class="border bg-sidebar rounded-md p-2">
                        <img class="w-16" src="{{ asset('img/department.png') }}" alt="" srcset="">
                    </div>
                </div>
                ...
                <div class="w-full md:w-fit border border-green-700 rounded-md p-4 flex gap-2 justify-between items-center">
                    ...
                    <div class="border bg-sidebar rounded-md p-2">
                        <img class="w-16" src="{{ asset('img/program.png') }}" alt="" srcset="">
                    </div>
                </div>
