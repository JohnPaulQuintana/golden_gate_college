                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-neutral-400">
                                List of new added <span class="font-bold">Liabilities</span> .
                            </p>
                        </div>
                            ...
                            @foreach ($liabilities as $liability)
                                ...
                                <tr class="@if($loop->odd) bg-green-50 dark:bg-neutral-800 @else bg-white dark:bg-neutral-900 @endif">
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block uppercase text-sm font-semibold w-fit bg-slate-100 rounded-md px-2 text-gray-800 dark:text-neutral-200">
                                                {{ $liability->name }} Semester
                                            </span>
                                        </div>
                                    </td>
                                    <td class="h-px w-72 whitespace-nowrap">
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                ...
                                                {{ $liability->liabilities_description }}
                                            </span>
                                        </div>
                                    </td>
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm font-semibold w-fit bg-slate-100 rounded-md px-2 text-gray-800 dark:text-neutral-200">
                                                {{ $liability->created_at->format('Y-m-d') }}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                ...
                                                class="edit-liability-btn block text-sm font-semibold w-fit bg-slate-100 rounded-md px-2 text-red-500 dark:text-neutral-200">
                                                <a href="#">Edit</a>
                                            </span>
                                        </div>
                                    </td>
                    ...
                    <!-- Custom Footer -->
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-neutral-700">
                            <div>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $liabilities->total() }}</span> results -
                                    <span class="font-semibold text-gray-800 dark:text-neutral-200">({{ $liabilities->count() }} on this page)</span>
                                </p>
                            </div>
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    ...
                                    @else
                                        <a href="{{ $liabilities->previousPageUrl() }}" class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
                                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="m15 18-6-6 6-6" />
                                            </svg>
                                            Prev
                                    ...
                                    @if ($liabilities->hasMorePages())
                                        <a href="{{ $liabilities->nextPageUrl() }}" class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
                                            Next
                                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
