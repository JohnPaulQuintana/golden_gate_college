<div class="text-center">
    <button id="edit_grade-modal-btn" type="button"
        ...
        aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-edit_grade-modal" data-hs-overlay="#hs-edit_grade-modal">
        Open modal
    </button>
</div>

<div id="hs-edit_grade-modal"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-[9999] overflow-x-hidden overflow-y-auto" role="dialog"
    tabindex="-1" aria-labelledby="hs-edit_grade-modal-label">
    <div
        ...
        <form action="{{ route('teacher.student.grade.edit') }}" method="post">
            @csrf
            ...
            <div
                ...
                <div class="absolute top-2 end-2">
                    <button type="button"
                        ...
                        aria-label="Close" data-hs-overlay="#hs-edit_grade-modal">
                ...
                <div class="p-4 sm:p-10 overflow-y-auto">
                    <div class="mb-6 text-center">
                        <h3 id="hs-edit_grade-modal-label"
                            class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">
                            Edit Student Grade to this Subject
                        </h3>
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-hs-overlay="#hs-edit_grade-modal">
                        Cancel
                    </button>
                    <button
