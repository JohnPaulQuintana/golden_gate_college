<div class="subject-card relative bg-white shadow-lg rounded-lg p-6 flex flex-col items-center transition-all duration-300 hover:shadow-xl hover:scale-105 transform">
    <!-- Icon Section -->
