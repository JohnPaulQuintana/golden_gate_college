<div class="text-center">
    <button id="create_schedule_btn_modal" type="button"
        ...
        data-hs-overlay="#hs-create_schedule">
        Open modal
    </button>
</div>

<div id="hs-create_schedule" class="hs-overlay hidden size-full fixed top-0 start-0 z-[9999] overflow-x-hidden overflow-y-auto"
        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-create_schedule">
                ...
                <form action="{{ route('schedule.upload') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="liability-card p-2 bg-slate-100 rounded-sm">
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Bachelor Degree</span>
                            <div class="mb-2">
                                
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <select required name="degree" required class="peer degree-option py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600">
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">College Level</span>
                            <div class="mb-2">
                                
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <select required name="college_level" class="peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600">
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Section</span>
                            <div class="mb-2">
                                
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <input required name="college_section" class="peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600" />
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Semester</span>
                            <div class="mb-2">
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Description</span>
                            <div class="mb-2">
                                
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <textarea required name="description" class="peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600" rows="3" placeholder="This is a textarea placeholder"></textarea>
                        ...
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Upload Class Schedule</span>
                            <div class="mb-2">
                                
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <input required type="file" name="schedule" class="peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600" rows="3" placeholder="This is a textarea placeholder" />
