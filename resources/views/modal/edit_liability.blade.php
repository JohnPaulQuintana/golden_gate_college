<div class="text-center">
    <button id="edit_liability_btn_modal" type="button"
        ...
        data-hs-overlay="#hs-edit_liability">
        Open modal
    </button>
</div>

<div id="hs-edit_liability" class="hs-overlay hidden size-full fixed top-0 start-0 z-[9999] overflow-x-hidden overflow-y-auto"
        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit_liability">
            ...
            <div class="p-4 sm:p-10 text-center overflow-y-auto">
                ...
                <form action="{{ route('liabilities.update') }}" method="post">
                    @csrf
                    <input type="number" name="liability_id" class="edit_liability_id hidden" value=""/>
