    ...
    <div class="w-full">
        <div class="mx-auto">
            ...
            <div class="overflow-hidden shadow-sm rounded p-2">
                ...
                @include('dean.form.add-subject-form')

            </div>
            {{-- modal --}}
            @include('dean.modal.edit_subject')
            {{-- table --}}
            @include('dean.table.subject',['subjects' => $subjects])
        </div>
    </div>
    ...
    @section('scripts')
        <script>
            $(document).ready(function(){
                ...
                $('.table_edit_subject_btn').click(function(){
                    // alert($(this).data('credits'))
                    let id = $(this).data('id')
                    ...
                    $('.credits').val(parseInt(credits))

                    $('#edit_subject_btn').trigger('click')
                })
                //popup message
