                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-neutral-400">
                                List of added <span class="font-bold">evaluation question</span> .
                            </p>
                        </div>
                            ...
                            @foreach ($categories as $ca)
                                ...
                                <tr class="@if($loop->odd) bg-green-50 dark:bg-neutral-800 @else bg-white dark:bg-neutral-900 @endif">
                                        ...
                                        <div class="px-2">
                                            <span
                                               ...
                                               <div class="flex flex-col gap-1">
                                                    <span class="px-1 capitalize rounded-md text-sm">{{ $ca->question }}</span> 
                                               </div>
                                            </span>
                                        </div>
                                    </td>
                                        ...
                                        <div class="px-6">
                                            <span
                                               ...
                                               <div class="flex flex-wrap gap-1">
                                                    ...
                                                    <span class="bg-red-500 px-1 capitalize rounded-md text-white text-xs">{{ $ca->ratings }}</span> 
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6">
                                            <span
                                                class="flex gap-1 text-sm font-semibold w-fit rounded-md text-gray-800 dark:text-neutral-200">
                                                <a href="#" 
                                                    data-id="{{ $ca->id }}" 
                                                    data-category_id="{{ $ca->category_id }}" 
                                                    data-category="{{ $ca->category }}" 
                                                    data-question="{{ $ca->question }}" 
                                                    data-ratings="{{ $ca->ratings }}" 
                                                    class="table_edit_evaluation_btn flex items-center gap-x-3.5 py-2 rounded-lg text-sm text-green hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700">
                                                    edit
                                                </a> 
                                                <a href="{{route('dean.evaluation.delete', $ca->id)}}" 
                                                    {{-- data-id="{{ $subject->id }}" 
                                                    data-code="{{ $subject->subject_code }}" 
                                                    data-name="{{ $subject->subject_name }}" 
                                                    data-credits="{{ $subject->credits }}"  --}}
                                                    class="table_edit_subject_btn flex items-center gap-x-3.5 py-2 rounded-lg text-sm text-red-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700">
                                                    delete
                                                </a> 
                                            </span>
                                        </div>
                    ...
                    <!-- Custom Footer -->
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-neutral-700">
                            <div>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $categories->total() }}</span> results -
                                    <span class="font-semibold text-gray-800 dark:text-neutral-200">({{ $categories->count() }} on this page)</span>
                                </p>
                            </div>
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    ...
                                    @else
                                        <a href="{{ $categories->previousPageUrl() }}" class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
                                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="m15 18-6-6 6-6" />
                                            </svg>
                                            Prev
                                    ...
                                    @if ($categories->hasMorePages())
                                        <a href="{{ $categories->nextPageUrl() }}" class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800">
                                            Next
                                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
