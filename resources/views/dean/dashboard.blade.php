        ...
        <div class="mx-auto">
            ...
            <div class="bg-sidebar overflow-hidden shadow-sm mb-2 sm:rounded-lg flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="hs-dropdown relative z-[999] inline-flex">
                    ...
                    <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-sidebar shadow-md rounded-lg p-1 space-y-0.5 mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-custom-trigger">
                      <a class="flex items-center gap-x-1.5 py-2 px-3 rounded-lg text-sm text-white hover:bg-hover focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="{{ route('profile.edit') }}">
          ...
          <div class="overflow-hidden shadow-sm rounded p-2">
              <div class="grid grid-cols-4 gap-2">
                  ...
                  {{-- liabilities count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Liabilities created</span>
                      <span class="text-4xl font-bold text-slate-800">2</span>
                  </div>

                  {{-- student's count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Student's</span>
                      <span class="text-4xl font-bold text-slate-800">1000</span>
                  </div>

                  {{-- teacher's count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Teacher's</span>
                      <span class="text-4xl font-bold text-slate-800">1000</span>
                  </div>

                  {{-- program's count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Program's</span>
                      <span class="text-4xl font-bold text-slate-800">1000</span>
                  </div>

                  {{-- subject's count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Subject's</span>
                      <span class="text-4xl font-bold text-slate-800">1000</span>
                  </div>
                  
                  {{-- class schedule's count --}}
                  <div class="bg-white p-2 py-5 border rounded-md flex flex-col gap-2 items-center justify-center">
                      <span class="font-semibold text-green">Class Schedule's</span>
                      <span class="text-4xl font-bold text-slate-800">1000</span>
                  </div>
