<div class="text-center">
    <button id="edit_level_btn" type="button"
        ...
        data-hs-overlay="#hs-edit_level">
        Open modal
    </button>
</div>

<div id="hs-edit_level" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto"
        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit_level">
            ...
            <div class="p-4 sm:p-10 text-center overflow-y-auto h-[400px]">
                <!-- Icon -->
                <span
                ...
                <form action="{{ route('dean.level.update') }}" method="post">
                    @csrf
                    <input type="number" name="level_id" id="edit_level_id" class="hidden">
                    <div class="p-2 bg-slate-100 rounded-sm">
                        <div class="flex flex-col max-w-full">
                            <span class="font-bold text-green uppercase tracking-wider">Year Level Section</span>
                            <div class="mb-2">
                                <div class="flex max-w-full gap-2 mb-2">
                                    {{-- Starting Year --}}
                                    <div class="flex-1 space-y-3">
                                        <div class="relative">
                                            <select id="level_select" name="year_level"
                                    ...
                                    <div class="flex-1 space-y-3">
                                        <div class="relative">
                                            ...
                                            <div class="relative">
                                                <button type="button"
                                                    class="dropdown-button flex justify-between items-center w-full py-3 px-4 bg-white rounded-md shadow-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 dark:bg-gray-800 dark:border-gray-600 dark:text-white">
                                                    <span
                                                        class="selected-options text-gray-700 dark:text-gray-200">Select
                                                        options...</span>
                                                ...
                                                style="z-index: 9999 !important;"
                                                    class="dp-subjects dropdown-menu hidden absolute left-0 right-0 mt-1 max-h-72 p-2 bg-white border border-gray-300 rounded-md shadow-lg overflow-auto z-[9999] dark:bg-gray-800 dark:border-gray-600">
