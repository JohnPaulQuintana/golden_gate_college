<div class="text-center">
    <button id="edit_email_btn_modal" type="button"
        ...
        data-hs-overlay="#hs-edit_email">
        Open modal
    </button>
</div>

<div id="hs-edit_email" class="hs-overlay hidden size-full fixed top-0 start-0 z-[9999] overflow-x-hidden overflow-y-auto"
        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit_email">
