<div class="text-center">
    <button id="edit_subject_btn" type="button"
        ...
        data-hs-overlay="#hs-edit_subject">
        Open modal
    </button>
</div>

<div id="hs-edit_subject" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto"
        ...
        <div class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-neutral-900">
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-edit_subject">
            ...
            <div class="p-4 sm:p-10 text-center overflow-y-auto">
                ...
                <form action="{{ route('dean.subjects.update') }}" method="post">
                    @csrf
                    <div class="p-2 bg-slate-100 rounded-sm">
                        <input type="number" name="subject_id" class="subject_id hidden">
                        <div class="flex flex-col max-w-full">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <input name="subject_code" placeholder="Enter Subject Code"
                                ...
                                <div class="flex-1 space-y-3 mb-2">
                                    <div class="relative">
                                        <input name="subject_name" placeholder="Enter Subject name"
                                            class="subject_name peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600" />
                                        <div
                                            class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-2 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                                            <svg class="shrink-0 size-4 text-green dark:text-neutral-500"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="flex-1 space-y-3">
                                    <div class="relative">
                                        <input type="number" name="credits" placeholder="Enter Credits"
                                            class="credits peer py-3 pe-0 ps-8 block w-full bg-white rounded-md border-t-transparent border-b-2 border-x-transparent border-b-gray-200 text-sm focus:border-t-transparent focus:border-x-transparent focus:border-b-[#32620e] focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:border-b-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 dark:focus:border-b-neutral-600" />
                                        <div
                                            class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-2 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                                            <svg class="shrink-0 size-4 text-green dark:text-neutral-500"
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
